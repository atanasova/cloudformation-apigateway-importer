...
But here at RBN, we don't just stop when AWS stops. So we took a sample CloudFormation input and hooked their java library into our java Lambda and with the help of CloudFormation Custom Resource we deployed the gateway. 
